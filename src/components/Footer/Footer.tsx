                ...
                <div className="flex justify-around py-[100px] max-800px:flex-col max-800px:py-[50px]">
                    ...
                    <div className="flex gap-[139px] max-800px:justify-center max-469px:flex-col-reverse">
                        <div className="flex flex-col">
                            <div
                                className="text-2xl font-medium leading-8 text-[#0D0C0C] mb-4 max-600px:text-[18px]/[1.3] max-469px:text-center max-469px:flex max-469px:justify-center max-469px:items-center max-469px:gap-[15px] ">
                                {t.info[lang]}
                                {_width < 469 && (
                                    <img
                                        src={arrowDown}
                        ...
                        <div className="flex flex-col">
                            <div
                                className="text-2xl font-medium leading-8 text-[#0D0C0C] mb-4 max-600px:text-[18px]/[1.3] max-469px:text-center">
                                {t.contacts[lang]}
                            </div>
